class NewClass {
    ...
    //     if(!this.isOpenStorage) return;
    //     if(key == undefined || value == undefined){
    //         console.error("setItem key is undefined");
    //     }
    //     cc.sys.localStorage.setItem(this.gameName + key,value);
    // }

    // getItem: function(key){
    //     if(!this.isOpenStorage) return;
    //     if(key == undefined){
    //         console.error("getItem key is undefined");
    //     }
    //     return cc.sys.localStorage.getItem(this.gameName + key);
    // }

    // removeItem: function(key){
    //     if(!this.isOpenStorage) return;
    //     if(key == undefined){
    //         console.error("removeItem key is undefined");
    //         return;
    //     }
    ...
    // private __key(val: string) {
    //     return wg.gameNameSpace + '_' + val
    // }
    ...
    //     return val ? this.__get(key) : null
    // }
